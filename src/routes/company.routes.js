...
const {companySignUp , companyLogin , postJob , getApplicants , getMyJobs , editJob , deleteJob , updateApplicantStatus , advanceApplicant, companyDashboard} = require('../controllers/company.controller');
...
router.patch('/applications/:applicationId/advance',authMiddleware,roleMiddleware('company'), advanceApplicant);
